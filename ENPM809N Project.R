...
# As we see, the independent variables Var05, Var06, Var09, Var11, Var15 have most significant contribution to the output (Response)(***).
# As we see, the independent variables Var18 have a decent amount of contribution to the output (Response)(**).
# As we see, the independent variables Var03, Var10, Var13, Var16 have some contribution to the output (Response)(*).
...
# As we can see that the independent variables Var03, Var04, Var08, Va10, Var16 are highly correlated because they have a high vif coefficient.
# Independent variables Var05, Var06, Var18 have a least vif coefficients, so they should definitely be part of linear models.
# Variables Var17, Var01, Var11, Var07, Var02 and Var15 are somewhat correlated but they have a significant contribution in the model1.
# So our final reduced model will have Var05, Var06, Var11, Var15, Var18 as independent variables by taking into consideration the summary of model1 and VIF coefficients.
# But, I will definnitely try for other models.
...
# From the anova function, it can be said that the reduced model4 is highly significant.
# Hence, Var05, Var06 and Var18 are the three final independent variables in the model.
...
# If Var18 <= 119.5, then probability that categorical response belongs to [a, b, c, d, e, f] is [0.769, 0, 0.077, 0.077, 0.077, 0] respectively.
# If Var18 > 119.5 and Var18 <= 128.9, then probability that categorical response belongs to [a, b, c, d, e, f] is [0, 0.714, 0.143, 0, 0, 0.143] respectively.
# If Var18 > 128.9 and Var18 <= 136.8, then probability that categorical response belongs to [a, b, c, d, e, f] is [0, 0, 0.727, 0.091, 0.091, 0.091] respectively.
# If Var18 > 136.8 and Var18 <= 150.6, then probability that categorical response belongs to [a, b, c, d, e, f] is [0, 0, 0, 0.2, 0.667, 0.133] respectively.
# If Var18 > 150.6, then probability that categorical response belongs to [a, b, c, d, e, f] is [0.083, 0.083, 0, 0.25, 0, 0.583] respectively.
...
error_matrix <- table(pred2, test.data$Categorical_Response)
error_matrix
...
library(C50)
tree <- C5.0(Categorical_Response ~ Var05 + Var06 + Var18, data = train.data)
tree

# If-then rules (found manually)-

# If Var06 <= 284.5, then Categorical Response belongs to class a.
# If Var06 > 284.5 and Var18 <= 136.8, Var18 <= 119.1 and Var15 <= 142 then Categorical Response belongs to class a.
# If Var06 > 284.5 and Var18 <= 136.8, Var18 <= 119.1 and Var15 > 142 then Categorical Response belongs to class c.
# If Var06 > 284.5 and Var18 <= 136.8, Var18 > 119.1 and Var15 <= 182 and Var06 <= 491.8 then Categorical Response belongs to class c.
# If Var06 > 284.5 and Var18 <= 136.8, Var18 > 119.1 and Var15 <= 182 and Var06 > 491.8 then Categorical Response belongs to class b.
# If Var06 > 284.5 and Var18 <= 136.8, Var18 > 119.1 and Var15 > 182 and Var18 <= 128.9 then Categorical Response belongs to class b.
# If Var06 > 284.5 and Var18 <= 136.8, Var18 > 119.1 and Var15 > 182 and Var18 > 128.9 then Categorical Response belongs to class e.
# If Var06 > 284.5 and Var18 > 136.8, Var18 <= 150.6, Var18 <= 146.6 and Var05 <= 109.6 then Categorical Response belongs to class e.
# If Var06 > 284.5 and Var18 > 136.8, Var18 <= 150.6, Var18 <= 146.6 and Var05 > 109.6 then Categorical Response belongs to class d.
# If Var06 > 284.5 and Var18 > 136.8, Var18 <= 150.6, Var18 > 146.6 then Categorical Response belongs to class e.
# If Var06 > 284.5 and Var18 > 136.8, Var18 > 150.6 and Var05 <= 137.6 then Categorical Response belongs to class d.
# If Var06 > 284.5 and Var18 > 136.8, Var18 > 150.6 and Var05 > 137.6 then Categorical Response belongs to class f.
...
# As we can see, the accuracy of the decision tree is increased from 0.5 to 0.5454 by using C5.0 algorithm.
...
# In xy1_rules$Var15, class [1, 2, 3] corresponds to [[112,139), [139,176), [176,200]] respectively.
